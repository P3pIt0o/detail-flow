  ...
  const steps: OnboardingStep[] = [
    {
      ...
      description: "Nom, téléphone et adresse.",
    ...
    },
    {
      ...
      description: "Vos infos légales et votre TVA.",
    ...
    {
      key: "publicSite",
      title: "Compléter ma présence en ligne",
      description: "Une description de votre activité et un téléphone.",
      done: signals.publicSiteComplete,
      href: "/admin/parametres?tab=site",
    },
    {
      key: "booking",
      title: "Tester ma première réservation",
      description: "Vérifiez que vos clients peuvent réserver sans accroc.",
