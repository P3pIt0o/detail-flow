 ...
 * Même vue latérale, même épaisseur de trait (1.8), roues à arches ouvertes.
 * Chaque type a une signature de proportions nettement distincte — aucune n'est
 * une répétition d'une autre. Aucun logo ni véhicule de marque.
 */
const ICON_SVG = {
  viewBox: "0 0 48 30",
  fill: "none",
...
/** SUV / 4x4 — carrosserie haute et massive, garde au sol marquée, grandes roues. */
function SuvIcon() {
  return (
    <svg {...ICON_SVG}>
